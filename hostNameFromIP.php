...
<!DOCTYPE html>
    ...
    <style>
      ...
      #form { 
        ...
        align-items: stretch;    /* Les éléments sont étirés sur tout l'axe.  */
      ...
      /**
      Les balises validation_ip_et_fin
      **/
      #pied
      {
        display: flex;
  ...
  <body>
    <form id="form" action="hostNameFromIP.php" method="POST">
      <div class="titre">
      ...
      <div id="entete_ip">
        ...
        <p class="ip_by_default">(par défaut, c'est la vôtre)</p>
      </div>
      <div id="corps_ip">
      ...
      <div id="validation_ip_et_fin">
        ...
        <div id="pied">
          ...
          <div class="validezCeDoc">
            <a href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fdeveweb.free.fr%2FhostNameFromIP.php">
              <p class="validezCeDoc">Validez ce document</p>
            </a>
          </div>
        </div> 
      </div>  
    ...
    <script>
      ...
      **/
      ...
      form.addEventListener("submit", function (event) {
        ...
        /** 
        Décommenter la ligne suivante pour n'exécuter que le code client
        event.preventDefault(); 
        **/
      });
      ...
      <?php
        if (isset($_POST['ip_php'])) {
          // A ce stade, grâce à l'expression régulière et à l'écouteur d'évènement, $ip_php a été validée.
          $phrase = "Le hostname de " . $_POST['ip_php'] . " est : ";
          $phrase .= gethostbyaddr($_POST['ip_php']);
