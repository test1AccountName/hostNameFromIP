    ...
    **/
    ...
    form.addEventListener("submit", function (event) {
      if(!validatedIP(document.getElementById("ip").value)) {
        ...
        retour.innerHTML = "Ici, les 4 nombres doivent être entre 0 et 255.";
    ...
    <?php
      // Si on est passé par le formulaire, alors la variable '$ip_php' a été définie (isset($ip_php) renvoie true).
      if (isset($ip_php)) {
